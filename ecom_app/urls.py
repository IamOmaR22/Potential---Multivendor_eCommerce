...
from .views import (
    ...
    DailyDataListAPIView, DailyDataDetailAPIView, CartItemListAPIView, ProductListTemplateView
)
...
urlpatterns = [
    ...
    path('products-list2/', ProductListTemplateView.as_view(), name='product-list'),
